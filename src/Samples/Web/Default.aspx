<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" Inherits="_Default" Codebehind="Default.aspx.cs" %>
...
<asp:Content ID="bodyContent" ContentPlaceHolderID="bodyContentPlaceHolder" runat="Server">
  ...
  <ul>
    <li><a href="Profile.aspx">Retrieve your profile information</a></li>
    <li><a href="Connections.aspx">Retrieve all your connections</a></li>
    <li><a href="UpdateStatus.aspx">Update your status</a></li>
  </ul>
